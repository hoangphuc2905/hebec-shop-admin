...
const ImportKiotVietSync = ({
  ...
  const [loadingGetDataExport, setLoadingGetDataExport] = useState(false);
  ...
  return (
    ...
    >
      ...
      />
      <Spin spinning={loadingGetDataExport}>
        <Button
          type="link"
          onClick={async (e) => {
            e.preventDefault();
...
export default ImportKiotVietSync;
